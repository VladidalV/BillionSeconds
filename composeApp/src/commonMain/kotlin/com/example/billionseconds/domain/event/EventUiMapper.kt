...
import com.example.billionseconds.mvi.event.PostEventActionUi
...
object EventUiMapper {
    ...
    fun toUiModel(domain: EventDomainModel, now: Instant): EventUiModel {
        ...
        val repeatModeNote = if (domain.mode == EventMode.REPEAT && domain.firstShownAt != null) {
            EventFormatter.formatRepeatModeNote(domain.firstShownAt, now)
        } else null
